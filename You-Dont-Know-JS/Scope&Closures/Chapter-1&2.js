...
//Lexical Scope
//lexical scope refers to the scope 'bubbles' that are created by nesting functions/blocks within eachother
//JS has lexical scope, not dynamic scope
//scope is defined at author time, not run time

//there are ways to cheat lexical scope, eval() and with(), they shouldn't be used
